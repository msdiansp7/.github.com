...
#writing data in csv on submitting    
...
def action():
    ...
    elif Hindi.get()==1 and English.get()==0:
        language="Hindi"
    elif English.get()==1 and Hindi.get()==0:
        language="English"
    else:
    ...
    with open("tkinterData.csv","a") as f:
        ...
        csv_writer.writerow(
        {"Name" : username , "Email" : userId, "Age" : userage, "Gender" : usergender, "Profession" : userprofession,"Language" : language }
        )
